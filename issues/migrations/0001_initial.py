# Generated by Django 4.1.7 on 2023-05-22 19:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', models.CharField(blank=True, choices=[('New', 'New'), ('In progress', 'In progress'), ('Ready for test', 'Ready for test'), ('Closed', 'Closed'), ('Needs info', 'Needs info'), ('Rejected', 'Rejected'), ('Posponed', 'Rejected')], max_length=50, null=True)),
                ('Type', models.CharField(blank=True, choices=[('Bug', 'Bug'), ('Question', 'Question'), ('Enhancement', 'Enhancement')], max_length=50, null=True)),
                ('Severity', models.CharField(blank=True, choices=[('Wishlist', 'Wishlist'), ('Minor', 'Minor'), ('Normal', 'Normal'), ('Important', 'Important'), ('Critical', 'Critical')], max_length=50, null=True)),
                ('Priority', models.CharField(blank=True, choices=[('Low', 'Low'), ('Normal', 'Normal'), ('High', 'High')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='activities', to=settings.AUTH_USER_MODEL)),
                ('Issue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='activities', to='issues.issue')),
                ('User', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_activities', to=settings.AUTH_USER_MODEL)),
            ],
        ),
