...
SECRET_KEY = os.environ.get('SECRET_KEY', default='django-insecure-x0lfh*)3yz@5yu)b5%zg&5k5_3n(9=y7ry7-o+^v*7*n72g$ku')
...
DATABASES = {
    'default': dj_database_url.config(    
        default='postgres://mohamed:EckX13zC2VJSjIi6s8q5ZI8s3YxVQN0P@dpg-cgs79q3k9u5foahvkhv0-a.frankfurt-postgres.render.com/issuetracker2',
        conn_max_age=600
    )
}
